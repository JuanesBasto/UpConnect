...
DROP DATABASE IF EXISTS UpConnect;
CREATE DATABASE UpConnect;
...
-- Tabla: Grupos (antes llamada Cursos)
...
CREATE TABLE IF NOT EXISTS Foros (
    ...
    ID_grupo INT,
    FOREIGN KEY (ID_materia) REFERENCES Materias(ID_materia),
    FOREIGN KEY (ID_grupo) REFERENCES Grupos(ID_curso)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Tabla: Comentarios en Publicaciones de Foros
...
CREATE TABLE IF NOT EXISTS Mapa_Interactivo (
    ...
    Salon VARCHAR(50),
    ID_curso INT,
    FOREIGN KEY (ID_curso) REFERENCES Grupos(ID_curso)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Tabla intermedia: Profesores_Materias
